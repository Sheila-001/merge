    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-64 bg-[#1B4B5A] text-white flex flex-col fixed h-full">
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('admin.events.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors">Events</a>
                <a href="{{ route('admin.students.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors">Applicants</a>
                <a href="{{ route('admin.volunteers.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors">Volunteers</a>
                <a href="{{ route('jobs.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors">Jobs</a>
                ...
                <div id="donationsSubmenu" class="pl-4 hidden">
                    ...
                    <a href="{{ route('admin.donations.create') }}" class="flex items-center px-4 py-2 hover:bg-[#2C5F6E] transition-colors text-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        Add New Donation
                    </a>
                    <a href="{{ route('admin.donations.dropoffs') }}" class="flex items-center px-4 py-2 hover:bg-[#2C5F6E] transition-colors text-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/>
                        </svg>
                        Drop-offs
                    </a>
                    <a href="{{ route('admin.urgent-funds.index') }}" class="flex items-center px-4 py-2 hover:bg-[#2C5F6E] transition-colors text-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Urgent Funds
                    </a>
                    <a href="{{ route('admin.campaigns.index') }}" class="flex items-center px-4 py-2 hover:bg-[#2C5F6E] transition-colors text-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-auto pt-20">
                    <a href="{{ route('logout') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors text-red-300 hover:text-red-200">Logout</a>
                </div>
            </nav>
        </div>
        <!-- Main Content -->
