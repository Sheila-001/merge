...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        ...
        <form class="mt-8 space-y-6" action="{{ route('student.register') }}" method="POST">
            @csrf
            ...
            <div class="text-center mt-4">
                <a href="{{ route('student.login') }}" class="text-sm text-indigo-600 hover:text-indigo-500">Already have an account? Login</a>
            </div>
        </form>
    </div>
</div>
