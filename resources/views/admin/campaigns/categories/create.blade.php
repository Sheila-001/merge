...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.campaigns-categories.index') }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="{{ route('admin.campaigns-categories.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <button type="button" 
                        onclick="window.location.href='{{ route('admin.campaigns-categories.index') }}'"
