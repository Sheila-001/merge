...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Scholarship Application') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('scholarship.apply') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="scholarship_type" class="col-md-4 col-form-label text-md-end">{{ __('Scholarship Type') }}</label>

                            <div class="col-md-6">
                                <select id="scholarship_type" class="form-control @error('scholarship_type') is-invalid @enderror" name="scholarship_type" required>
                        ...
                        <div class="row mb-3">
                            <label for="transcript" class="col-md-4 col-form-label text-md-end">{{ __('Transcript') }}</label>

                            <div class="col-md-6">
                                <input id="transcript" type="file" class="form-control @error('transcript') is-invalid @enderror" name="transcript" required>
