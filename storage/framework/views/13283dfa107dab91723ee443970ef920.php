...
<div class="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-12 mb-20 mt-80 border-t-4 border-primary">
    ...
    <?php
        ...
        $currentDonation = DB::table('monetary_donations')->sum('amount');
     ...
     <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
         <div class="bg-[#B7E4FA] rounded-2xl shadow-lg p-8 flex items-center space-x-6">
             <div class="w-16 h-16 bg-[#B7E4FA] rounded-full flex items-center justify-center">
                 <span class="text-black font-semibold text-lg">JA</span>
             </div>
             <span class="text-gray-800 font-medium text-lg">John Anderson</span>
         </div>
         <div class="bg-[#B7E4FA] rounded-2xl shadow-lg p-8 flex items-center space-x-6">
             <div class="w-16 h-16 bg-[#B7E4FA] rounded-full flex items-center justify-center">
                 <span class="text-black font-semibold text-lg">SW</span>
             </div>
             <span class="text-gray-800 font-medium text-lg">Sarah Williams</span>
         </div>
         <div class="bg-[#B7E4FA] rounded-2xl shadow-lg p-8 flex items-center space-x-6">
             <div class="w-16 h-16 bg-[#B7E4FA] rounded-full flex items-center justify-center">
...
<?php /**PATH C:\Users\PNPh\Desktop\sheila\collab\resources\views/donation/donation.blade.php ENDPATH**/ ?>