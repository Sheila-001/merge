...
<div class="calendar-container">
    <div class="calendar-header">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="action-btn secondary">
                <i class="fas fa-tags me-2"></i>Manage Categories
            </a>
            <a href="<?php echo e(route('admin.campaigns.create')); ?>" class="action-btn primary">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('components.app-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PNPh\Desktop\sheila\collab - Copy\resources\views\admin\calendar\index.blade.php ENDPATH**/ ?>