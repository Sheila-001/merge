...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Edit Urgent Campaign</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="<?php echo e(route('admin.urgent-funds.update', $campaign->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title', $campaign->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="5" required><?php echo e(old('description', $campaign->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="goal_amount" name="goal_amount" value="<?php echo e(old('goal_amount', $campaign->goal_amount)); ?>" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <?php if($campaign->image): ?>
                    <div class="mb-2">
                        <img src="<?php echo e(asset('storage/' . $campaign->image)); ?>" alt="Current Image" class="h-32 rounded">
                    </div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" id="is_urgent" name="is_urgent" value="1" <?php echo e(old('is_urgent', $campaign->is_urgent) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PNPh\Desktop\sheila\collab - Copy\resources\views\admin\donation\urgent-fund\edit.blade.php ENDPATH**/ ?>