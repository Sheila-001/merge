...
<div class="container mx-auto px-4 py-6">
    ...
    <?php if($categories->isEmpty()): ?>
        <div class="mb-4 p-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 rounded">
            No categories found. <a href="<?php echo e(route('admin.categories.index')); ?>" class="underline text-blue-700">Manage categories</a> to create one first.
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('components.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\collab\resources\views/admin/campaigns/create.blade.php ENDPATH**/ ?>