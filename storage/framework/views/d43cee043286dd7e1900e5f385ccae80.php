...
<?php $component->withAttributes([]); ?>
    <div class="p-8 bg-[#f3f6fb] min-h-screen">
        ...
        <div class="bg-white rounded-xl shadow p-6 mb-8 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.donations.calendar')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors">View Calendar</a>
