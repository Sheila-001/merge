...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="checkbox" class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="is_urgent" name="is_urgent" value="1" <?php echo e(old('is_urgent') ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\Users\PNPh\Desktop\sheila\collab - Copy\resources\views/admin/campaigns/create.blade.php ENDPATH**/ ?>