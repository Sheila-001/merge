...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            ...
            <a href="<?php echo e(route('admin.campaigns-categories.create')); ?>" 
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">
                                    No categories found. <a href="<?php echo e(route('admin.campaigns-categories.create')); ?>" class="text-[#1B4B5A] hover:underline">Create one now</a>.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
...
<script>
    function openEditModal(id, name, color, description) {
        document.getElementById('editForm').action = `<?php echo e(url('admin/campaigns-categories')); ?>/${id}`;
    ...
    function openDeleteModal(id, name) {
        document.getElementById('deleteForm').action = `<?php echo e(url('admin/campaigns-categories')); ?>/${id}`;
...
<?php echo $__env->make('components.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\collab\resources\views/admin/campaigns/categories/index.blade.php ENDPATH**/ ?>