                ...
                <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-transform duration-200 hover:-translate-y-1">
                        <div class="relative h-56">
                            <img src="<?php echo e(asset('storage/' . ($campaign->image ?? 'default.jpg'))); ?>"
                                 alt="<?php echo e($campaign->title ?? 'Campaign Image'); ?>"
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="bg-[#0A90A4] text-white px-4 py-1.5 rounded-full text-sm font-medium shadow-md">
                                    <?php echo e($campaign->title ?? 'N/A'); ?>

                                </span>
                            </div>
                            <div class="absolute top-4 right-4">
                                <span class="bg-[#0A90A4] text-white px-4 py-1.5 rounded-full text-sm font-medium shadow-md">
                                    <?php echo e(ucfirst($campaign->status ?? 'N/A')); ?>

                                </span>
                            </div>
                        </div>
                        <div class="p-6">
                            <p class="text-gray-600 text-sm mb-4"><?php echo e($campaign->description ?? 'No description available.'); ?></p>
                            
                            <!-- Progress Bar -->
                            <div class="mb-4">
                                <div class="flex justify-between text-sm text-gray-500 mb-1">
                                    <span>Progress</span>
                                    <span><?php echo e(number_format($campaign->progress_percentage ?? 0, 0)); ?>%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                    <div class="bg-[#0A90A4] h-2.5 rounded-full" style="width: <?php echo e($campaign->progress_percentage ?? 0); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-[#0A90A4] font-semibold">₱<?php echo e(number_format($campaign->goal_amount ?? 0, 2)); ?></p>
                                </div>
                                <a href="<?php echo e(route('monetary_donation', ['campaign_id' => $campaign->id])); ?>" class="bg-[#0A90A4] hover:bg-[#0A90A4] text-white px-6 py-2 rounded-lg transition-colors text-sm font-medium shadow-sm hover:shadow-md">
                                    Join Campaign
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="month-calendar">
                        ...
                        <div class="days-grid">
                            ...
                            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                                ...
                                <div class="<?php echo e($cellClasses); ?>" data-date="<?php echo e($date); ?>">
                                    <?php echo e($day); ?>
                                    ...
                                    <?php if($hasEvents): ?>
                                        ...
                                        ?>
                                        <div class="event-dot" style="background-color: <?php echo e($statusColor); ?>"></div>
                                        ...
                                        <div class="hidden event-details-tooltip">
                                            <?php $__currentLoopData = $dayEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="event-tooltip">
                                                    <div class="event-tooltip-header" style="background-color: <?php echo e($event['categoryColor']); ?>">
                                                        <div class="event-tooltip-title"><?php echo e($event['title']); ?></div>
                                                    </div>
                                                    <div class="event-tooltip-body">
                                                        <div class="event-tooltip-detail">
                                                            <i class="fas fa-tag"></i>
                                                            Category: <?php echo e($event['category']); ?>

                                                        </div>
                                                        <div class="event-tooltip-detail">
                                                            <i class="fas fa-calendar-alt"></i>
                                                            Date: <?php echo e(\Carbon\Carbon::parse($event['start'])->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($event['end'])->format('M d, Y')); ?>

                                                        </div>
                                                        <div class="event-tooltip-detail">
                                                            <i class="fas fa-info-circle"></i>
                                                            Status: <?php echo e(ucfirst($event['status'])); ?>

                                                        </div>
                                                        <?php if(!empty($event['notes'])): ?>
                                                            <div class="event-tooltip-detail">
                                                                <i class="fas fa-sticky-note"></i>
                                                                Notes: <?php echo e($event['notes']); ?>
