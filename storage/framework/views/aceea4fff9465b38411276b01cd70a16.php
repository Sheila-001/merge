        ...
        <div class="w-64 bg-[#1B4B5A] text-white flex flex-col fixed h-full">
            ...
            <nav class="mt-8">
                ...
                <div id="donationsSubmenu" style="display: none;">
                    ...
                    <a href="<?php echo e(route('admin.donations.index')); ?>" class="flex items-center px-8 py-3 hover:bg-[#2C5F6E] transition-colors text-sm">
                        └ Reports
                    </a>
...
</html><?php /**PATH C:\Users\PNPh\Desktop\sheila\collab - Copy\resources\views/components/app-layout.blade.php ENDPATH**/ ?>