        ...
        <div class="flex-1 bg-gray-100">
            ...
            <div class="bg-white p-4 flex justify-between items-center shadow-sm">
                ...
                <div class="flex space-x-3">
                    <a href="<?php echo e(route('events.index')); ?>" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-200">
                        Back to Events
                    </a>
                    <a href="<?php echo e(route('events.edit', $event)); ?>" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">
                        Edit Event
                    </a>
                </div>
            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="mt-1 text-lg"><?php echo e($event->title); ?></p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1"><?php echo e($event->location); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="mt-1"><?php echo e($event->start_date->format('F j, Y g:i A')); ?></p>
                                    </div>
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">End Date & Time</h4>
                                        <p class="mt-1"><?php echo e($event->end_date->format('F j, Y g:i A')); ?></p>
                                    </div>
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Duration</h4>
                                        <p class="mt-1"><?php echo e($event->start_date->diffForHumans($event->end_date, true)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\PNPh\Desktop\sheila\collab - Copy\resources\views\admin\events\show.blade.php ENDPATH**/ ?>