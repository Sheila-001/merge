...
class PublicDonationController extends Controller
{
    ...
    public function submitNonMonetaryDonation(Request $request)
    {
        ...
        // Assign expected_date separately
        $donation->expected_date = \Carbon\Carbon::parse($request->expected_date)->format('Y-m-d H:i:s');

        // Log the model attributes before saving
        \Illuminate\Support\Facades\Log::info('Donation model attributes before saving:', $donation->getAttributes());
